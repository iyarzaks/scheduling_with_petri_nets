...
def main():
    ...
    result = solve_file_problem_as(
        a_path="/Users/iyarzaks/PycharmProjects/scheduling_with_petri_nets/RCPSP-AS/RCPSPAS_data_Servranckx_and_Vanhoucke_EJOR_2019 2/Instances/file28a.RCP",
        b_path="/Users/iyarzaks/PycharmProjects/scheduling_with_petri_nets/RCPSP-AS/RCPSPAS_data_Servranckx_and_Vanhoucke_EJOR_2019 2/Instances/file28b.RCP",
        logging=True,
    )
    print(result)
